...
c           printing out integrated values.  This option worked on early
c           versions, but has not been tested on the latest versions.
     ...
     x     ,kkk/1/,umax/0./,yield/0./ftarold/0.0/
...
c  read in real mdel from NMR data
      read(1,*)mdel
c  read in mass fractions of C,H,N, and O in parent coal
      read(1,*)fcar
      read(1,*)fhyd
      read(1,*)fnit
      read(1,*)foxy
